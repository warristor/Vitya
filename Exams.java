...
public class Exams extends Examination {
    ...
    public Exams(String participant, String subject1, String subject2, int examEstimate1, int examEstimate2, int minEstimate) {
	...
	return "Exams [Participant= " + getParticipant() + ", Subject1= " + getSubject1() + ", examEstimate1= "
